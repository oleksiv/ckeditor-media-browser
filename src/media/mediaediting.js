...
export default class MediaEditing extends Plugin {
    ...
    init() {
        ...
        conversion.for('editingDowncast').elementToElement({
            model: 'media',
            view: (element, writer) => {
                const view = createMediaViewElement(element, writer);
                editor.plugins
                    .get(WidgetResize).attachTo({
                        unit: 'px',
                ...
                return toMediaWidget(view, writer, t('Media Widget'))
            }
        });
        ...
        types.forEach(item => {
            ...
            conversion.for('upcast').elementToElement({
                model: (element, writer) => writer.createElement('media', {
